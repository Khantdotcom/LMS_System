...
import TelegramLoginButton from '@/components/TelegramLoginButton' // Reusing your existing component
        ...
        <main className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-slate-900 border border-slate-800 p-8 rounded-2xl shadow-2xl">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400">Sign in to access your GIFT-Ed Dashboard</p>
                </div>

                <div className="space-y-4">

                    {/* OPTION 1: GOOGLE LOGIN */}
                    {/* We use a Server Action inline here for simplicity */}
                    <form
                        action={async () => {
                            "use server"
